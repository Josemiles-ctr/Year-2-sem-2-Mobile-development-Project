...
object MockSeedData {
    ...
    fun create(now: Long, passwordHash: String): MockSeedBundle {
        val hospitals = listOf(
            HospitalEntity("HOSPITAL_1", "ADMIN_1", "City Central Hospital", "hospital1@resq.local", "555-0100", "123 Healthcare Ave", 40.7128, -74.0060, "UUID_HOSP_1", passwordHash, HospitalStatus.APPROVED, 3, now - 900_000, now - 300_000),
            HospitalEntity("HOSPITAL_2", "ADMIN_2", "Northside Medical", "hospital2@resq.local", "555-0101", "78 North Street", 40.7306, -73.9352, "UUID_HOSP_2", passwordHash, HospitalStatus.APPROVED, 2, now - 890_000, now - 290_000),
            HospitalEntity("HOSPITAL_3", "ADMIN_3", "West End General", "hospital3@resq.local", "555-0102", "91 West End Blvd", 40.7350, -74.0020, "UUID_HOSP_3", passwordHash, HospitalStatus.APPROVED, 2, now - 880_000, now - 280_000),
            HospitalEntity("HOSPITAL_4", "ADMIN_4", "East River Clinic", "hospital4@resq.local", "555-0103", "14 River Road", 40.7210, -73.9800, "UUID_HOSP_4", passwordHash, HospitalStatus.APPROVED, 3, now - 870_000, now - 270_000),
            HospitalEntity("HOSPITAL_5", "ADMIN_5", "South Metro Hospital", "hospital5@resq.local", "555-0104", "501 South Metro", 40.7001, -73.9901, "UUID_HOSP_5", passwordHash, HospitalStatus.PENDING, 0, now - 860_000, now - 260_000),
            HospitalEntity("HOSPITAL_6", "ADMIN_6", "Lakeside Emergency", "hospital6@resq.local", "555-0105", "8 Lake View", 40.7450, -73.9700, "UUID_HOSP_6", passwordHash, HospitalStatus.APPROVED, 1, now - 850_000, now - 250_000),
            HospitalEntity("HOSPITAL_7", "ADMIN_7", "Greenfield Health", "hospital7@resq.local", "555-0106", "300 Greenfield", 40.7421, -73.9550, "UUID_HOSP_7", passwordHash, HospitalStatus.REJECTED, 0, now - 840_000, now - 240_000),
            HospitalEntity("HOSPITAL_8", "ADMIN_8", "Harborpoint Medical", "hospital8@resq.local", "555-0107", "22 Harbor St", 40.7105, -74.0150, "UUID_HOSP_8", passwordHash, HospitalStatus.APPROVED, 1, now - 830_000, now - 230_000),
            HospitalEntity("HOSPITAL_9", "ADMIN_9", "Hillview Trauma", "hospital9@resq.local", "555-0108", "44 Hillview Lane", 40.7601, -73.9802, "UUID_HOSP_9", passwordHash, HospitalStatus.APPROVED, 1, now - 820_000, now - 220_000),
            HospitalEntity("HOSPITAL_10", "ADMIN_10", "Sunrise Care Center", "hospital10@resq.local", "555-0109", "77 Sunrise Ave", 40.7511, -73.9402, "UUID_HOSP_10", passwordHash, HospitalStatus.APPROVED, 1, now - 810_000, now - 210_000)
        )
